---
title: "B4_04_top_variant_all_OTU_CF lm  "
...
```{r}
file_name_ext="B4_04_top_variant_all_OTU_CF"
```
...
```{r}
#to include only ECC samples
Samples312_covariates_vcf_clr_microbiome_CF = Samples538_covariates_vcf_clr_microbiome %>% 
  filter(ECC_status == 0)
Samples312_covariates_vcf_clr_microbiome_CF
```
...
linear_model <- glm(B_s_Streptococcus_mutans ~ chr15_40303364_PLCB2_rs2305645 +Age+Sex+PC1+PC2+PC3+PC4+PC5+RuralUrban+SEFI_score,
                     data =Samples312_covariates_vcf_clr_microbiome_CF,
                     family = gaussian)
