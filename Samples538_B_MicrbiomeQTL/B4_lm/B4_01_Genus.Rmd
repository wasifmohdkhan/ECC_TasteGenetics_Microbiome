---
title: "B4_01_Genus_sig_variant_all_OTU lm"
...
```{r}
file_name_ext="B4_01_Genus_sig_variant_all_OTU"
```
...
Plaque538_16S_Genus_CLR = readr::read_tsv(here("Samples538_A_Geno_Microbiome/A2_Maaslin/Maaslin2_16S_Genus_output/features",
                                            "filtered_data_norm.tsv"))
Plaque538_16S_Genus_CLR
```
ITS microbiome
```{r}
# Import the Maaslin features
Plaque538_ITS_Genus_CLR = readr::read_tsv(here("Samples538_A_Geno_Microbiome/A2_Maaslin/Maaslin2_ITS_Genus_output/features",
                                            "filtered_data_norm.tsv"))
Plaque538_ITS_Genus_CLR
...
Plaque538_16S_ITS_Genus_CLR_OTU = full_join(Plaque538_16S_Genus_CLR, Plaque538_ITS_Genus_CLR, by = "feature") %>%
  rename(IID = feature)
Plaque538_16S_ITS_Genus_CLR_OTU %>% head()

# Plaque538_16S_ITS_Genus_CLR_OTU_2 = Plaque538_16S_ITS_Genus_CLR_OTU %>%
#   # column_to_rownames(var = "IID") %>%
#   # dplyr::select(-FID) %>% 
#   identity()
# Plaque538_16S_ITS_Genus_CLR_OTU_2 

Plaque538_16S_ITS_Genus_CLR_OTU_names = Plaque538_16S_ITS_Genus_CLR_OTU %>% 
  dplyr::select(-IID) %>%
  colnames()
Plaque538_16S_ITS_Genus_CLR_OTU_names
```



## microbiome file with only Maaslin2 significant Genus
...
```{r}
# Plaque538_16S_ITS_Genus_CLR_OTU_sig = Plaque538_16S_ITS_Genus_CLR_OTU_2 %>%
#   # dplyr::select(one_of(Maaslin2_16S_ITS_features_names)) %>% 
#   identity()
# Plaque538_16S_ITS_Genus_CLR_OTU_sig
# 
# ## feature names
# Plaque538_16S_ITS_Genus_CLR_OTU_sig_names = Plaque538_16S_ITS_Genus_CLR_OTU_sig %>% 
#   dplyr::select(-IID) %>%
#   names()
# Plaque538_16S_ITS_Genus_CLR_OTU_sig_names 
...
Samples538_covariates_vcf_clr_microbiome <- Samples538_covariates_2 %>%
  ...
  inner_join(Plaque538_16S_ITS_Genus_CLR_OTU, by = "IID") %>%
...
for (OTU in Plaque538_16S_ITS_Genus_CLR_OTU_names) {
...
ggplot(linear_model_results_df_3, aes(x = variant, y = OTU, fill = linear_model_estimate)) +
  ...
  labs(x = "Genetic variants", y = "Microbial Genus") +
  theme(
...
ggsave(here("Samples538_B_MicrbiomeQTL/B4_lm",
       ...
       height = 4,
       units = "cm")
saveRDS(combined_plot, here("Samples538_B_MicrbiomeQTL/B4_lm",
         paste0(file_name_ext, "_Heatmap_Forest.rds")))
```
