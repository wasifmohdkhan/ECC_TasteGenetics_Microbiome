---
title: "mbQTL_top_variant_sig_species_additive_model"
...
Samples538_Plink_logit_covASPB_w_anno_2 = Samples538_Plink_logit_covASPB_w_anno %>% 
  ...
  filter(P_BH <= quantile(P_BH, 0.05, na.rm = T)) %>%
  filter(A1 != '*') %>%
...
#                        "B1_04_Samples538_mbQTL_top_variant_sig_species.tsv"),
...
ggsave(here("Samples538_B_MicrbiomeQTL/B1_mbQTL_additive",
            "B1_04_Samples538_mbQTL_top_variant_sig_species.png"),
       Samples538_LinearAnalysisTaxaSNP_heatmap,
       width = 12,
       height = 8,
       dpi = 300)
