---
title: "A5_08_Plink_additive_model8 Age,Sex,PC1,PC2,PC3,PC4,PC5,RuralUrban,SEFI_score --dominant flag"
...
```{r}
filext = "A5_08_Plink_additive_model8"
```
...
--covar-name Age,Sex,PC1,PC2,PC3,PC4,PC5,RuralUrban,SEFI_score  \
