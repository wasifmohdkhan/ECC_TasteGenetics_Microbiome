---
title: "Plink with Age,Sex,PC1,PC2,PC3,PC4,PC5,SEFI_score,Urban_status dominant model"
...
```{r}
filext = "A1_02_Samples538_55gene_logistic_dominant"
out_dir = "A1_02_Plink_dominant"
...
mkdir -p /media/Second_stor/wasif/WK_Rprojects/RP_240910_Taste_Genes_Analysis_2/Samples538_A_Geno_Microbiome/A1_Plink/A1_02_Plink_dominant/
cd /media/Second_stor/wasif/WK_Rprojects/RP_240910_Taste_Genes_Analysis_2/Samples538_A_Geno_Microbiome/A1_Plink/A1_02_Plink_dominant/
...
--out ./Samples538_55gene_Plink_geno.01_maf.01_hwe.00001_logistic_dominant
```
...
```{r}
logit_assoc_file = read.table(here("Samples538_A_Geno_Microbiome/A1_Plink/A1_02_Plink_dominant",
                             "Samples538_55gene_Plink_geno.01_maf.01_hwe.00001_logistic_dominant.assoc.logistic"),
                        header = T)
...
write.table(assoc_file_df_chromPOS_to_gene_variant_adjP_3, 
            here("Samples538_A_Geno_Microbiome/A1_Plink/A1_02_Plink_dominant",
...
```{r}
Samples538_Plink_logit_cov_w_anno = read.table(here("Samples538_A_Geno_Microbiome/A1_Plink/A1_02_Plink_dominant",
                                                               paste0(filext,"_cov_anno.txt")),
                                                          header = T)
...
```{r}
ggplot_title = "Plot with logistic dominant model"
...
Samples538_Plink_logit_cov_w_anno = Samples538_Plink_logit_cov_w_anno %>% 
   mutate(
    OR = as.numeric(OR),  # Convert OR from character to numeric
    lower_CI = exp(log(OR) - 1.96 * SE),
    upper_CI = exp(log(OR) + 1.96 * SE)
   )
Samples538_Plink_logit_cov_w_anno
