---
title: "Plink with Age,Sex,PC1,PC2,PC3,PC4,PC5,SEFI_score,Urban_status additive model"
...
```{r}
filext = "A1_01_Samples538_55gene_logistic_additive"
out_dir = "A1_01_Plink_additive"
...
mkdir -p /media/Second_stor/wasif/WK_Rprojects/RP_240910_Taste_Genes_Analysis_2/Samples538_A_Geno_Microbiome/A1_Plink/A1_01_Plink_additive/
cd /media/Second_stor/wasif/WK_Rprojects/RP_240910_Taste_Genes_Analysis_2/Samples538_A_Geno_Microbiome/A1_Plink/A1_01_Plink_additive/
...
--out ./Samples538_55gene_Plink_geno.01_maf.01_hwe.00001_logistic_additive
```
...
```{r}
logit_assoc_file = read.table(here("Samples538_A_Geno_Microbiome/A1_Plink/A1_01_Plink_additive",
...
write.table(assoc_file_df_chromPOS_to_gene_variant_adjP_3, 
            here("Samples538_A_Geno_Microbiome/A1_Plink/A1_01_Plink_additive",
...
```{r}
Samples538_Plink_logit_cov_w_anno = read.table(here("Samples538_A_Geno_Microbiome/A1_Plink/A1_01_Plink_additive",
                                                               paste0(filext,"_cov_anno.txt")),
                                                          header = T)
...
```{r}
ggplot_title = "Plot with logistic additive model"
