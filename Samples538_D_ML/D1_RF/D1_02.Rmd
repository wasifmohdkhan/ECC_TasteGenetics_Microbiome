---
title: "Variants ML models comparison and RF vip"
...
```{r}
# job::job({ rmarkdown::render("/media/Second_stor/wasif/WK_Rprojects/RP_240910_Taste_Genes_Analysis_2/Samples538_D_ML/D1_RF/D1_02.Rmd")}, title = "Running Rmd D1_02 in background")
```
...
ggplot(roc_curve_data_2, aes(x = 1 - specificity, y = sensitivity, color = Model_performance)) +
  ...
  labs(title = "Variants_variants_AUROC_Comparison") +
  theme(
...
ggplot(VIP_df_RF, aes(y = Variable, x = Relative_importance)) +
  ...
  labs(x = "Relative Variable Importance",  # Replace with your x-axis label
       y = "Variants Features",  # Replace with your y-axis label
       title = "Variants_variable_importance") +
