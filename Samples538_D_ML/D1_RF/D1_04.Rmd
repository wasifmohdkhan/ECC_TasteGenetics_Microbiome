---
title: "Covariates_variants_16S_ITS ML models comparison and RF vip"
...
```{r}
# job::job({ rmarkdown::render("/media/Second_stor/wasif/WK_Rprojects/RP_240910_Taste_Genes_Analysis_2/Samples538_D_ML/D1_RF/D1_04.Rmd")}, title = "Running Rmd D1_04 in background")
```
...
```{r}
file_name_ext = "D1_04_Covariates_variants_16S_ITS"
...
ggplot(VIP_df_RF, aes(y = Variable, x = Relative_importance)) +
  ...
  labs(x = "Relative Variable Importance",  # Replace with your x-axis label
       y = "Covariates_variants_16S_ITS Features",  # Replace with your y-axis label
       title = "Covariates_variants_16S_ITS_variable_importance") +
