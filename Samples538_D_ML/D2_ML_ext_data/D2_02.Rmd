---
title: "16S ML models comparison and RF vip and perf on ext data"
...
```{r}
# job::job({ rmarkdown::render("/media/Second_stor/wasif/WK_Rprojects/RP_240910_Taste_Genes_Analysis_2/Samples538_D_ML/D2_ML_ext_data/D1_01.Rmd")}, title = "Running Rmd D1_01 in background")
```
...
grid_sizes <- list(
  ...
  Lasso = 150,
  SVM = 300,
  RandomForest = 450 #, # remove comma if commenting the next line
  # LightGBM = 50
)
...
saveRDS(tuning_results,
        file = here("Samples538_D_ML/D2_ML_ext_data",
            paste0(file_name_ext, "_tuning_results.rds")))
```

```{r}
tuning_results <- readRDS(file = here("Samples538_D_ML/D2_ML_ext_data",
            paste0(file_name_ext, "_tuning_results.rds")))
```
...
saveRDS(auroc_auprc_values,
        here("Samples538_D_ML/D2_ML_ext_data",
...
saveRDS(VIP_df_RF, here("Samples538_D_ML/D2_ML_ext_data",
...
for (model_name in model_names) {
  ...
  for (dataset_name in dataset_names) {
    ...
    dataset_file <- file.path(dataset_folder, paste0(dataset_name, "_MaAsLin2_CLR_ECCstatus.rds"))
...
saveRDS(final_results, file = here("Samples538_D_ML/D2_ML_ext_data",
...
```{r}
# Read the data
ext_datasets_arroc_auprc_results = readRDS(here("Samples538_D_ML/D2_ML_ext_data",
                                                paste0(file_name_ext, "ext_datasets_arroc_auprc_results.rds")
                                                ))
